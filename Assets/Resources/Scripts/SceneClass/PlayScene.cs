...
public class PlayScene : Scene {
    ...
    public override void Initialize()
    {
        ...
        cameraTransform.position = new Vector3(characters[DifficultyScene.selectIdx].transform.position.x, 
                                               characters[DifficultyScene.selectIdx].transform.position.y + 13, 
    ...
    public override void Updated()
    {
        ...
        // 몬스터 라이프
        monsterhp.rectTransform.sizeDelta = new Vector2((Monster.hp / XmlTools.data.monsterHP) * 250, 20);
        monsterhpText.text = ((int)((monsterhp.rectTransform.sizeDelta.x / 250) * 100)).ToString() + "%";

        score_Text.text = score.ToString("00000");
